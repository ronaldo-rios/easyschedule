...
CREATE TABLE `page_levels`(
    ...
    -- `permission` INT NOT NULL DEFAULT O,
...
VALUES
    ...
    ('Permissions', 'index', 'permissions', 'index','Permissões de Acesso', 0, 1, 1, 1, NOW()),
    ('EditPermission', 'index', 'edit-permission', 'index', 'Atualizar Permissões de Nível de Acesso', 0, 1, 4, 1, NOW()),
    ...
    ('ViewProfile', 'index', 'view-profile', 'index', 'Visualizar Perfil de Usuário Logado', 0, 1, 2, 1, NOW()),
    ('EditProfile', 'index', 'edit-profile', 'index', 'Atualizar Perfil de Usuário Logado', 0, 1, 4, 1, NOW()),
    ('Users', 'index', 'users', 'index', 'Usuários', 0,1, 1, 1, NOW()),
    ...
    ('AccessLevels', 'index', 'access-levels', 'index', 'Níveis de Acesso', 0, 1, 1, 1, NOW()),
    ('AddAccessLevel', 'index', 'add-access-level', 'index', 'Adicionar Novo Nível de Acesso', 0, 1,3, 1, NOW()),
    ('EditAccessLevel', 'index', 'edit-access-level', 'index', 'Editar Nível de Acesso', 0, 1, 4, 1, NOW()),
    ('DeleteAccessLevel', 'index', 'delete-access-level', 'index', 'Deletar Nível de Acesso', 0, 1, 5, 1, NOW()),
    ('EmailServers', 'index', 'email-servers', 'index', 'Servidores de Email', 0, 1, 1, 1, NOW()),
    ('ViewEmailServers', 'index', 'view-email-servers', 'index', 'Visualizar Servidor de Email', 0, 1, 2, 1, NOW()),
    ('AddEmailServer', 'index', 'add-email-server', 'index', 'Adicionar Novo Servidor de Email', 0, 1, 3, 1, NOW()),
    ('EditEmailServer', 'index', 'edit-email-server', 'index', 'Editar Servidor de Email', 0, 1, 4, 1, NOW()),
    ('DeleteEmailServer', 'index', 'delete-email-server', 'index', 'Remover Servidor de Email', 0, 1, 5, 1, NOW()),
    ('Pages', 'index', 'pages', 'index', 'Páginas para acesso', 0, 1, 1, 1, NOW()),
    ('ViewPage', 'index', 'view-page', 'index', 'Visualizar Página', 0, 1, 2, 1, NOW()),
    ('AddPage', 'index', 'add-page', 'index', 'Cadastrar Nova Página', 0, 1, 3, 1, NOW()),
    ('EditPage', 'index', 'edit-page', 'index', 'Editar Página', 0, 1, 4, 1, NOW()),
    ('DeletePage', 'index', 'delete-page', 'index', 'Deletar Página', 0, 1, 5, 1, NOW()),
    ('PageGroups', 'index', 'page-groups', 'index', 'Listar Grupos de Páginas', 0, 1, 1, 1, NOW()),
    ('ViewPageGroup', 'index', 'view-page-group', 'index', 'Visualizar Grupo de Página', 0, 1, 2, 1, NOW()),
    ('AddPageGroup', 'index', 'add-page-group', 'index', 'Cadastrar Novo Grupo de Página', 0, 1, 3, 1, NOW()),
    ('EditPageGroup', 'index', 'edit-page-group', 'index', 'Editar Grupo', 0, 1, 4, 1, NOW()),
    ('DeletePageGroup', 'index', 'delete-page-group', 'index', 'Deletar Grupo de Página', 0, 1, 5, 1, NOW()),
    ('PageModules', 'index', 'page-modules', 'index', 'Listar Módulos', 0, 1, 1, 1, NOW()),
    ('ViewPageModule', 'index', 'view-page-module', 'index', 'Visualizar Módulo', 0, 1, 2, 1, NOW()),
    ('AddPageModule', 'index', 'add-page-module', 'index', 'Cadastrar Novo Módulo', 0, 1, 3, 1, NOW()),
    ('EditPageModule', 'index', 'edit-page-module', 'index', 'Editar Módulo', 0, 1, 4, 1, NOW()),
    ('DeletePageModule', 'index', 'delete-page-module', 'index', 'Deletar Módulo', 0, 1, 5, 1, NOW());
